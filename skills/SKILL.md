---
slug: yahoo-stock-analysis
version: 1.0.0
displayName: 股票分析（Stock Analysis）
summary: "基于 Yahoo Finance API 的综合股票分析技能。支持公司概况、技术面/基本面分析、K线图表、内部人持股、SEC 文件查询和多股对比。需要平台提供 Yahoo Finance API 工具集成（如 MCP）。来源：Manus 平台导出。"
tags: stock, finance, yahoo, analysis, investment, market-data
name: stock-analysis
